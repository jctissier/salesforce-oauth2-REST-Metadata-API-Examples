...
| [Force.com SOAP API](https://github.com/jctissier/Salesforce-Oauth2-REST-SOAP-API-Python-Examples/blob/master/README.md#soap-api---username-password-oauth-authentication-flow) - Not completed                      | [Link]           | [Link]  |
